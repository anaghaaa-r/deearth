...
<body>
    ...
    <header id="header" class="d-flex flex-column justify-content-center">
        ...
        <ul>
                ...
                <li><a href="{{ url('/management/change-password') }}" class="nav-link scrollto active"><i class="bx bxs-lock-open-alt"></i> <span>CHANGE PASSWORD</span></a></li>
            </ul>
        </nav><!-- .nav-menu -->
    ...
    <section id="hero" style="padding-bottom: 100px;">
        ...
        <div class="main_body px-5">
            ...
            <h2 class="ps-5">CHANGE PASSWORD</h2>
            <form id="adding-form" method="post" action="{{ route('change.password') }}" class="px-5" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="btn btn-all mt-2" data-bs-dismiss="modal">Save changes</button>
