  ...
  <div id="wrap">
          ...
          <div class="col-inner lh-adjust" style="text-align:left;">
            <div class="nav">
              <ul>
                ...
                <a href="{{ url('institution') }}" class="marked">INSTITUTION</a>
    ...
    <div id="content-col" class="supercol col right col-f-537">
      ...
      @foreach ($institutions as $institution)
        ...
        <a href="{{ url('institution-details', $institution->id) }}" class="block auto" data-tags="" data-categories="" data-obj="0">
    
          <div class="fifty fifty-right">
            <div class="img-holder hover01"><img src="{{ asset('storage/' . $institution->thumbnail)}}"><!--<div class="a-center"><div class="a-center-mark">&nbsp;</div>&nbsp;</div>--></div>
          </div>
        </a>
