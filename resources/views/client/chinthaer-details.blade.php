  ...
  <div id="wrap">
    ...
    <div id="nav-col" class="supercol col col-f-165 menumargintop">
      <div class="col-inner lh-adjust">
        ...
        <a href="{{ url('/publications') }}"><span class="icons">A</span> CHINTHAER</a>
      ...
      <div class="col-inner lh-adjust">
        <div class="works-post">
          ...
          <div class="chunk title">
            <h2>{{ $chinthaer->name }}</h2>
            <!-- <div class="meta-data">
              <p>Perinthalmanna, Kerala, India<br>2020</p>
            </div> -->
          </div>
          <div class="chunk works-body editable">
            <p>{!! $chinthaer->description !!}</p>
            <!--<p class="credit">Project team<br>Maria Bello, Max Gleeson, Chris Masson, Nicholas Barba<br><br>Curator<br>Carrie Scott<br><br>Words<br>Alison Morris<br><br>Lunula Construction<br>Yabashi Marble Co., Ltd.<br><br>Photography<br>Keishin Horikoshi / SS<br><br>More information can be found at <a href="http://themass.jp/en/" target="_blank" rel="noreferrer noopener">themass.jp</a></p>
				   	<p class="credit"></p>-->
          </div>
        </div>
      </div>
