  ...
  <div id="wrap">
          ...
          <div class="col-inner lh-adjust" style="text-align:left;">
            <div class="nav">
              <ul>
                ...
                <a href="{{ url('commercial') }}" class="marked">COMMERCIAL</a>
    ...
    <div id="content-col" class="supercol col right col-f-537">
      ...
      @foreach ($commercials as $commercial)
        ...
        <a href="{{ url('commercial-details', $commercial->id) }}" class="block auto" data-tags="" data-categories="" data-obj="0">
    
          <div class="fifty fifty-right">
            <div class="img-holder hover01"><img src="{{ asset('storage/' . $commercial->thumbnail)}}"><!--<div class="a-center"><div class="a-center-mark">&nbsp;</div>&nbsp;</div>--></div>
          </div>
        </a>
