  ...
  <div id="menublockright">
    <div id="menublock-margin">
      <div class="col-inner lh-adjust">
        ...
        <div class="relative">
          <h1><a href="#"><img src="{{ asset('img/logoright.svg') }}" width="68"></a></h1>
  ...
  <div id="menublocksocial">
    <div id="">
      <div class="">
        ...
        <div class="relative">
          <a href="https://www.facebook.com/profile.php?id=100044406168884" target="_blank"><img src="{{ asset('img/fb.png') }}"></a>
          <a href="https://www.instagram.com/de_earth_architects/" target="_blank"><img src="{{ asset('img/insta.png') }}"></a>
          <a href="https://www.youtube.com/channel/UCAFy-1B7N2uSlh2IkImec2A" target="_blank"><img src="{{ asset('img/youtu.png') }}"></a>
          <a href="https://www.linkedin.com/company/de-earth" target="_blank"><img src="{{ asset('img/linkd.png') }}"></a>
