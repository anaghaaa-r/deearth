      ...
      <div id="section" class="section">
        <div id="nav-col" class="supercol col col-f-165 menumargintop">
          ...
          <a href="office.html" ><span class="icons">A</span> Office</a>-->
            ...
            <div class="nav">
              <ul>
                <a href="{{ url('aboutus') }}" class="marked">ABOUT US</a>
          ...
          <div class="col-inner lh-adjust">
            <div class="page-post">
              <div class="chunk page-body editable">
                ...
                <div class="img-holder"><img data-width="1000" data-height="666" src="{{ asset('storage/' . $aboutus->thumbnail) }}"></div>

                <h2>{{ $aboutus->title }}</h2>

                <h3>{{ $aboutus->subtitle }}</h3>

                <p>{!! nl2br($aboutus->description) !!}</p>
