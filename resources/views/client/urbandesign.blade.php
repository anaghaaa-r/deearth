  ...
  <div id="menublock">
    <div id="menublock-margin">
      <div class="col-inner lh-adjust">
        ...
        <div class="relative">
          <h1><a href="{{ url('/') }}"><img src="{{ url('img/logo.svg') }}" width="180" height="35"></a></h1>
  ...
  <div id="wrap">
          ...
          <div class="col-inner lh-adjust" style="text-align:left;">
            <div class="nav">
              <ul>
                ...
                <a href="{{ url('urbandesign') }}" class="marked">URBAN DESIGN</a>
    ...
    <div id="content-col" class="supercol col right col-f-537">
      ...
      @foreach ($urbandesigns as $urbandesign)
        ...
        <a href="{{ url('urbandesign-details', $urbandesign->id) }}" class="block auto" data-tags="" data-categories="" data-obj="0">
          ...
          <div class="fifty fifty-right">
            <div class="img-holder hover01"><img src="{{ asset('storage/' . $urbandesign->thumbnail)}}"><!--<div class="a-center"><div class="a-center-mark">&nbsp;</div>&nbsp;</div>--></div>
          </div>
        </a>
