...
class HomesController extends Controller
{
    ...
    public function create(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'monogram' => 'required|image|mimes:jpeg,jpg,png,gif|dimensions:width=800,height=600'
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => 'Successfully added to homes.'
            ], 200);
            // return redirect()->route('homes')->with('success', 'Successfully added to homes.');
        } 
        catch(\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function edit(Request $request, $id)
    {
        ...
        if(empty($updatedData))
        {
            ...
            // return redirect()->route('edit.home', $id)->with('success', 'Nothing to update.'); 
        }
        ...
        try {
            ...
            // return redirect()->route('homes', $id)->with('success', 'Successfully updated.');
        }
        catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    {
        try {
            $work = Home::findOrFail($id);

            $work->gallery()->where('home_id', $id)->delete();
