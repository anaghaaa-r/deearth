...
use App\Models\ChinthaerGallery;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class ChinthaerGalleryController extends Controller
{
    // add image
        ...
        try {
            ...
            if($request->hasFile('images'))
            {
                foreach ($request->file('images') as $image)
                {
                    ...
                    $imagePath = 'uploads/archives/chinthaer/gallery/' . $filename;
            ...
            if(!empty($uploadedImages))
            {
                ...
                $chinthaer->gallery()->createMany($imageData);
    ...
    {
        try {
            $image = ChinthaerGallery::findOrFail($id);
