document.addEventListener('DOMContentLoaded', function () {
    ...
    const minimumLength = 360;
    const readMore = '...<span class="read-more"><span class="las la-plus-circle"></span>Read More</span>';
    const readLess = '<span class="read-less"><span class="las la-minus-circle"></span>Read Less</span>';
